  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-5 justify-center">
        <button className="py-3 px-5 border-1 border-gray-500 rounded-lg">
          All categories
        </button>
        <button className="py-3 px-5 border- border-gray-500 rounded-lg">
          Payment Status
        </button>
      </div>

      <div className="flex flex-col mt-8 w-full bg-white gap-3 p-6">
          ...
          >
            ...
            <div className="flex flex-col  px-2">
              ...
              <h2 className="text-sm font-medium">
                GH₵ {Number(transaction.amount).toLocaleString()}.00
              </h2>
            </div>
          </div>
        ))}
