  ...
  return (
    <div>
      ...
      <section>
        <div>
          <motion.div
            className="w-full h-210 bg-gradient-to-r from-blue-700 to-blue-900 flex flex-col justify-center items-center p-10"
      ...
      <section>
        <div className="mt-0 w-full h-480 bg-[#fafafa] flex flex-col p-10">
          <div className="mt-15 flex gap-10 flex-col items-center justify-center w-full bg-300 pb-13 ">
            <div className="text-blue-900 font-light text-base px-7 py-3 rounded-full bg-blue-200">
              HOW TO GET STARTED
            </div>
          ...
          className="mt-0 flex gap-10 flex-col items-center justify-center w-full bg-re-300 pb-13 ">
            <div 
            className="w-10 h-10 p-7 text-xl flex justify-center items-center text-white font-medium text-base rounded-full bg-blue-700 border-6 border-blue-100">
              <span>1</span>
            </div>
          ...
          <div className="w-full h-60 bg--300 mt-2 flex flex-col justify-center items-center">
            <div className="w-1 h-60 bg-blue-100"></div>
          </div>
          ...
          className="mt-10 flex gap-10 flex-col items-center justify-center w-full bg--300 pb-13 ">
            <div className="w-10 h-10 p-7 text-xl flex justify-center items-center text-white font-medium text-base rounded-full bg-blue-700 border-6 border-blue-100">
              <span>2</span>
            </div>
          ...
          transition={{ duration: 0.9, ease: "easeOut" }} //
           className="flex flex-col w-full  bg--400">
            <div className="w-full  ">
              <div className="pl-4 mt-10 w-40 text-center flex flex-col justify-center items-center rounded-full h-10 bg-blue-100 ">
                OUR BENEFITS
              </div>
            </div>
      ...
      <section>
        <div className=" mt-10 w-full bg--300 gap-20 flex flex-col pl-6 pr-6">
          {/* <div className="rounde mt-10 mt-6 w-full h-140 shadow-xl flex  flex flex-col p-6">
            <div className="px-3 py-2 rounded-full bg-blu-200">
              Diverse Investment Options
            </div>
            <h2 className="font-medium text-5xl leading-normal mt-12">
              See,Click, Invest!
            </h2>
            ...
            <div className="flex gap-5 items-center mt-12 px-3 py-6 text-lg rounded-lg bg-gradient-to-r from-blue-200 to-blue-400">
              Explore Diverse Offers{" "}
              <span>
          ...
          <motion.div
            className="rounde mt-10 mt-6 w-full h-140 shadow-xl flex flex-col p-6"
            initial={{ opacity: 0, y: 50 }} // start invisible, 50px below
            whileInView={{ opacity: 1, y: 0 }} // animate to visible, y=0
            viewport={{ once: true, amount: 0.3 }} // animate once when 30% in view
            transition={{ duration: 0.6, ease: "easeOut" }} // smooth animation
          >
            <div className="px-3 py-2 rounded-full bg-blue-200">
              Diverse Investment Options
            </div>
            <h2 className="font-medium text-5xl leading-normal mt-12">
              See, Click, Invest!
          ...
          viewport={{ once: true, amount: 0.8 }} // animate once when 30% in view
          transition={{ duration: 0.9, ease: "easeOut" }} //
           className="rounde bg-500 mt-10 mt-6 w-full h-190 flex  shadow-xl  flex flex-col p-6 ">
            ...
            <p className="font-smsall text-lg mt-12 ">
              ...
              execution,our intuitive interface ensures every step is simple and
              straightforward
            </p>
            <div className="flex gap-5 items-center mt-12 px-3 py-6 text-lg rounded-lg  bg-gradient-to-r from-blue-200 to-blue-400">
          ...
          viewport={{ once: true, amount: 0.8 }} // animate once when 30% in view
          transition={{ duration: 0.9, ease: "easeOut" }} //
           className="rounde mt-10 mt-6 w-full h-190 flex shadow-xl flex flex-col pt-6 pl-6 pr-6">
          ...
          className="flex flex-col gap-30">
            <img
              src={image2}
              className="rounde mt-10 bg-gradient-to-r from-blue-300 to-blue-100 w-full h-120 flex bg-gree-100 flex flex-col "
            ></img>
            <motion.div
            initial={{ opacity: 0, y: 50 }} // start invisible, 50px below
          whileInView={{ opacity: 1, y: 0 }} // animate to visible, y=0
          viewport={{ once: true, amount: 0.8 }} // animate once when 30% in view
          transition={{ duration: 0.9, ease: "easeOut" }} //
             className=" w-full rounded- mt-20 bg-gradient-to-r from-blue-900 to-blue-600  p-6 pb-10">
          ...
          <div className="flex flex-col gap-10 w-full h-170  bg-gradient-to-r from-blue-900 to-blue-600 p-6 pt-15 mt-20">
            <div className="w-full bg-orang-500 p-2">
              ...
              <button className="rounded-sm px-8 py-3 mt-10 bg-white font-bold text-xl">
                Start investing
              </button>
            </div>

           <div className="w-full bg-blue-600 p-2">
              <p className="text-white font-medium text-lg">If you invested every month </p>
              <p className="text-white font-medium text-xl">4 years ago</p>
              <div className="flex mt-10">
                <input type="text"className="w-full flex-1 border-b outline-none border-white" />
                <select>
