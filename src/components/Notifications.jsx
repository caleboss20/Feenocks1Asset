...
function Notifications() {
  ...
  // ✅ timestamps are created ONCE and stored
  const [notifications] = useState(() => [
    ...
    },
    {
      ...
      description:
        "We would setup your investor profile and would be active in 3 days time.",
      time: new Date().toISOString(),
    },
    {
      title: "Enable 2FA,💰",
        ...
        <div>
          ...
          <div className="mt-5 w-full flex flex-col gap-6">
            {notifications.map((item) => (
              ...
              >
                <div className="py-1 px-1 bg-gray-100 h-13 w-13 inline-flex rounded-full justify-center items-center">
