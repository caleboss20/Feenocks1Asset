...
const questions = [
  ...
  },
  {
    ...
    options: [
      "$1,000 in cash",
      "A 50% chance at $5,000",
      "A 25% chance at $10,000",
      "A 5% chance at $100,000"
    ],
  },
  {
    id: 3,
    ...
    options: [
      ...
      "Go as planned",
      "Extend the vacation — you need it"
    ],
  },
  {
    id: 4,
    ...
    options: [
      ...
      "Buy safe bonds or T-Bills",
      "Invest in stocks",
      "Put it all in high-risk investments"
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    options: [
      ...
      "Sell some bonds",
      "Sell most bonds",
      "Sell all bonds and buy hard assets"
    ],
  },
  {
    id: 8,
    ...
    options: [
      "Gain $200 or lose $0",
      "Gain $800 or lose $200",
      "Gain $2,600 or lose $800",
      "Gain $4,800 or lose $2,400"
    ],
  },
  {
    id: 9,
    ...
    options: [
      "Take a sure gain of $500",
      "A 50% chance to gain $1,000",
      "A 25% chance to gain $2,000",
      "A 5% chance to gain $10,000"
    ],
  },
  {
    id: 10,
  ...
  },
  {
    ...
    options: [
      "A savings account or T-Bills",
      "A bond mutual fund",
      "A stock mutual fund",
      "A mix of small-cap and international stocks"
    ],
  },
  {
    id: 12,
  ...
  },
  {
    ...
    options: [
      ...
      "A small amount",
      "A reasonable amount",
      "A large amount — big risk, big reward"
    ],
  }
];
  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="text-2xl font-semibold text-black text-left ml-6 mt-30"
      >
      ...
      {questions.map((q, index) => (
        <motion.div
          ...
          className="bg-white-900 rounded-2xl p-5 -lg  -white-800"
        >
