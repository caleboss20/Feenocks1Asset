      ...
      <div className=" mt-8">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex gap-5 mt-10">
            <div className="h-14 w-14  rounded-full bg-blue-100 flex justify-center items-center ">
        ...
        <div className="mt-30 flex flex-col gap-4 w-full h-45 bg-viole-300 p-6">
          ...
          <button
            onClick={next}
            className="w-full px-4 py-3 bg-blue-600 rounded-lg text-white font-medium text-lg"
          >
            Continue
          </button>
          <span
